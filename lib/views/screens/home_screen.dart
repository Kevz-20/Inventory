...
class _HomeScreenState extends ConsumerState<HomeScreen> with RouteAware {
  ...
  Widget build(BuildContext context) {
    ...
    appSession.whenData((session) {
      ...
      if (orgName != homeState.organizationName) {
        ref.read(homeViewModelProvider.notifier).setOrganizationName(orgName);
      }
    });
    ...
    final mobileText = homeState.organizationName?.isNotEmpty == true
        ? '${homeState.organizationName} • ${homeState.mobileNumber ?? "Not set"}'
        : (homeState.mobileNumber ?? "Not set");
